export const environment = {
  ...
  API_LIFE_HISTORY:  `${window.location.protocol}//${window.location.hostname}:${window.location.port}${window.location.pathname.slice(0, window.location.pathname.lastIndexOf("ui/"))}lifestory`,
