...
export class ProfileTemplateService {
  ...
  async getAllEstudies() {
    ...
    return await this.httpClient
      .get(`${environment.API_MUNDO_SETI}/studies?status=true`)
      .pipe(pluck('payload'))
      .toPromise()
    // return [
    //   {
  ...
  async getAllCertificates() {
    return await this.httpClient
    .get(`${environment.API_MUNDO_SETI}/courses-certifications?status=true`)
    .pipe(pluck('payload'))
    .toPromise()
    // return [
    //   {
  ...
  async getAllKnowledge() {
    return await this.httpClient
    .get(`${environment.API_MUNDO_SETI}/specific-knowledge?status=true`)
    .pipe(pluck('payload'))
    .toPromise()
    // return [
    //   {
  ...
  async getAllFunctions() {
    return await this.httpClient
    .get(`${environment.API_MUNDO_SETI}/functions?status=true`)
    .pipe(pluck('payload'))
    .toPromise()
    // return [
    //   {
  ...
  async getAllTalents() {
    return await this.httpClient
    .get(`${environment.API_MUNDO_SETI}/skills?status=true`)
    .pipe(pluck('payload'))
    .toPromise()
    // return [
    //   {
...
historyActions(action: string, data?: any) {
  if (action === 'get'){
    return this.httpClient
      .get(`${environment.API_MUNDO_SETI}/historical-records`)
      .pipe(pluck('payload'))
      .toPromise();
  } else if (action === 'post') {
    // console.log(data)
    return this.httpClient
    .post(`${environment.API_MUNDO_SETI}/historical-records`, data)
    .pipe(pluck('payload'))
    .toPromise();
  }
  }
