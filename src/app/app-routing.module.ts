...
const routes: Routes = [
  ...
  },
  {
    path: "movements",
    loadChildren: () =>
      import("./screens/sites/movements/movements.module").then(
        (m) => m.MovementsModule
      ),
  },
  {
    path: "temperature",
    loadChildren: () =>
      import("./screens/sites/temperature/temperature.module").then(
  ...
  },
  {
    path: "kits",
    loadChildren: () =>
      import("./screens/sites/kits/kits.module").then((m) => m.KitsModule),
  },
  {
